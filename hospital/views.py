...
#for showing signup/login button for admin(by AnkitPandey)
...
#for showing signup/login button for doctor(by AnkitPandey)
...
#for showing signup/login button for patient(by AnkitPandey)
...
#-----------for checking user is doctor , patient or admin(by AnkitPandey)
def is_admin(user):
